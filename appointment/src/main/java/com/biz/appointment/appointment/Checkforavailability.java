package com.biz.appointment.appointment;
...
public class Checkforavailability implements JavaDelegate {
	...
	/*	boolean flag = false;
		...
		execution.setVariable("name", "vivek");
		execution.setVariable("availabilityOk", rando.nextBoolean());
